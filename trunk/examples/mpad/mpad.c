...
chs_t sweep(chs_t trk, char *swdef, int param, int value, unsigned long tick)
{
  ...
  if (endtk > 0) {
    ...
    switch (param) {
      ...
      case swp_pan      : strcpy(buf,"!pan"); break;
      case swp_pitch    : strcpy(buf,"!pitch"); break;
