...
#define tblGetNT(tb,k,d)  valGetT(tbl_get(tb, 'N', k, NULL, 'S', 0, d))
#define tblGetST(tb,k,d)  valGetT(tbl_get(tb, 'S', 0, k   , 'S', 0, d))
#define tblGetPT(tb,k,d)  valGetT(tbl_get(tb, 'P', 0, k   , 'S', 0, d))
#define tblGetTT(tb,k,d)  valGetT(tbl_get(tb, 'T', 0, k   , 'S', 0, d))
...
#define vecGetT(tb,k,d)  valGetT(vec_get(tb, k , 'N', 0, d))
